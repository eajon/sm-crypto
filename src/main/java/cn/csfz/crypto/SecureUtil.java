...
import cn.csfz.core.io.FileUtil;
import cn.csfz.core.util.ArrayUtil;
import cn.csfz.core.util.HexUtil;
import cn.csfz.core.util.ObjectUtil;
import cn.csfz.core.util.StrUtil;
import cn.csfz.crypto.asymmetric.AsymmetricAlgorithm;
import cn.csfz.crypto.asymmetric.RSA;
import cn.csfz.crypto.asymmetric.Sign;
import cn.csfz.crypto.asymmetric.SignAlgorithm;
import cn.csfz.crypto.digest.*;
import cn.csfz.crypto.symmetric.*;
import cn.csfz.crypto.symmetric.fpe.FPE;
...
//	}
	...
	public static byte[] decode(String key) {
		return HEX.matcher(key).matches() ? HexUtil.decodeHex(key) : Base64.decode(key);
	}
