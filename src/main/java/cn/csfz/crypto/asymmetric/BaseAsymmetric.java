...
public class BaseAsymmetric<T extends BaseAsymmetric<T>> implements Serializable {
	...
	public String getPublicKeyBase64() {
		...
		return (null == publicKey) ? null : new String(Base64.encode(publicKey.getEncoded()));
	}
	...
	public String getPrivateKeyBase64() {
		...
		return (null == privateKey) ? null : new String(Base64.encode(privateKey.getEncoded()));
	}
