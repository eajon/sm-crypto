...
import cn.csfz.core.io.FastByteArrayOutputStream;
...
public class ASN1Util {
	...
	public static void encodeTo(String asn1Encoding, OutputStream out, ASN1Encodable... elements) {
		...
		if(asn1Encoding.equals(ASN1Encoding.DER))
		{
			sequence = new DERSequence(elements);
		}else if(asn1Encoding.equals(ASN1Encoding.BER))
		{
			sequence = new BERSequence(elements);
		}else if(asn1Encoding.equals(ASN1Encoding.DL))
		{
